...
import com.example.testdemo.common.page.PageModel;
...
public class UserController {
	...
	public String insertOrUpdateSave(Model model, HttpServletRequest request, @Validated User user, String pageType, String roleIds){
